...
<head>
  ...
  <meta charset="utf-8">
    ...
    <title> NACC | The Independence Investment Forum 2019</title>
...
<div class="wrapper dark-header">
  <header class="main-header">
    <div class="logo"><center>
      <a href="{{url('/')}}" >STOCK MANAGEMENT SYSTEM</a>
    </center></div>
      ...
      <div class="login-details">
        <form method="POST" action="">
          ...
          @if(session()->has('error'))
            <div class="alert alert-danger" style="background-color: #ff656c; color:white; padding:5px; border-radius: 5px;">
                ...
                <div class="alert alert-success">
                    {{-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> --}}
                    <strong>Aww!</strong> {{session()->get('success')}}...
                </div> <br>
            @endif
